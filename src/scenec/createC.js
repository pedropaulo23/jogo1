...
export function create() {
   ...
   // mapbb.setCollisionByProperty({ collider: true });
    ...
    for (let i = 0; i < seeds.length; i++) {
        const [x, y] = seeds[i];
        const enemy = createEnemyContainer(this, x, y, 'dragao');
   ...
   // this.enemies.add(enemy);
    ...
    this.projectiles2 = this.physics.add.group({
     ...
     //this.physics.add.collider(this.projectiles, [mapbase], hitProjectile, null, this);
     ...
     this.physics.add.collider(this.playerContainer, mapbase);
